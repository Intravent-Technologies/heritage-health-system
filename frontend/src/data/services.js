export const servicesMap = {
  ...
  'medication-management': {
    ...
    sections: [
      { heading: 'Personalized Medication Plans', content: 'Our medication management services provide careful monitoring and adjustment of psychiatric medications to ensure optimal effectiveness while minimizing side effects.' },
      { heading: 'Regular Follow-ups', content: 'We schedule regular follow-up appointments to track your progress, address any concerns, and make necessary adjustments to your medication regimen.' },
      { heading: 'Collaborative Approach', content: 'We work closely with you and your primary care provider to ensure coordinated care. Your input is valued in every decision about your treatment.' },
      { heading: 'Benefits of Medication Management', content: 'With regular monitoring and adjustments, your medications will work more effectively, helping you feel better faster. Proper medication management helps reduce side effects and ensures that your treatment plan is as comfortable as possible.' },
    ],
  },
  'person-centered-behavioral-healthcare': {
    ...
    sections: [
      ...
      { heading: 'Our Philosophy', content: 'We believe that effective behavioral healthcare recognizes the whole person, not just their symptoms. Our approach integrates evidence-based practices with genuine compassion and respect for each individual\'s unique life experiences.' },
      { heading: 'What to Expect', content: 'Your journey begins with a comprehensive assessment to understand your unique circumstances. From there, we collaborate with you to develop a personalized treatment plan that aligns with your values and goals.' },
    ],
  },
  'counseling-services': {
    ...
    sections: [
      ...
      { heading: 'Safe & Confidential Space', content: 'We provide a non-judgmental, confidential environment where you can explore your thoughts and feelings openly with a trained professional.' },
      { heading: 'Our Approach to Mental Health Counseling', content: 'Our mental health counseling services deliver personalized care by meeting the specific requirements of each client. Licensed counselors utilize evidence-based therapy methods to assist clients in understanding their emotions, learning healthy coping strategies, and discovering solutions to life\'s problems.' },
    ],
  },
  'diagnostic-evaluation': {
    ...
    sections: [
      ...
      { heading: 'Clear Recommendations', content: 'Following your evaluation, we provide a detailed report with diagnostic findings and evidence-based treatment recommendations.' },
      { heading: 'Our Comprehensive Process', content: 'Heritage Health System implements a systematic evidence-based methodology during evaluations. Our licensed professionals start the process by conducting detailed clinical interviews to collect information about the individual\'s mental health history, symptoms, and concerns.' },
    ],
  },
  'telehealth-services': {
